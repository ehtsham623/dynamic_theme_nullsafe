...
class DynamicThemeNullsafe extends StatefulWidget {
  const DynamicThemeNullsafe({
    Key? key,
  ...
  @override
  DynamicThemeNullsafeState createState() => DynamicThemeNullsafeState();

  static DynamicThemeNullsafeState of(BuildContext context) {
    return context.findAncestorStateOfType<DynamicThemeNullsafeState>()!;
  }
}

class DynamicThemeNullsafeState extends State<DynamicThemeNullsafe> {
  ...
  @override
  void didUpdateWidget(DynamicThemeNullsafe oldWidget) {
